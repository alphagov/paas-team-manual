...
### How-to
 ...
 - [How to horizontally scale routers](guides/scaling_routers_horizontally)
...
## Team Accounts and Software
 - [So you're the person on support for GOV.UK PaaS](support/so_you_are_on_support/)
...
This section contains Architecture Decision Records (ADR) as described in this blog post <http://thinkrelevance.com/blog/2011/11/15/documenting-architecture-decisions>.
 ...
 - [ADR-053 Plan for maintaining product pages post Ireland retirement](architecture_decision_records/ADR053-paas-product-pages-ireland)
